...
function ConvertTo-Double {
    ...
    <#
        ...
        .DESCRIPTION
        The `ConvertTo-Boolean` function converts a values, strings, or objects to a double value.
        ...
        .OUTPUTS
        [double]  `ConvertTo-Double` returns a byte value to the PowerShell pipeline.
...
function ConvertTo-String {
    ...
    PROCESS {
        switch ($PSCmdlet.ParameterSetName) {
            ...
            'UsingDateTime' {
                $DateTime | ForEach-Object -Process { [System.Convert]::ToInt32($_) } | Write-Output
                break
            }
